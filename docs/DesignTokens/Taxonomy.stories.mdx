...
Example: `cds.color.blue.800`, which holds the value `#004ce6`.
...
Example: `cds.color.background.primary`, which points to `cds.color.blue.800`.
...
Example: `cds.button.color.background.primary`, which points to `cds.color.background.primary`.
