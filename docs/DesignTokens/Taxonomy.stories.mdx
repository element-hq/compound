...
Example: `cpd.color.background.primary`, which points to `cpd.color.blue.800`.
...
Example: `cpd.button.color.background.primary`, which points to `cpd.color.background.primary`.
