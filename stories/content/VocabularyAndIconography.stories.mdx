...
<table>
  ...
  <tr>
    <td>
      <strong>Verification & Trust</strong>
    </td>
    <td>Verify user</td>
    <td>
...
(image)
   ...
   <td><strong>Untrusted device or person</strong></td>
   <td>Profile</td>
  </tr>
  <tr>
   <td>
...
(image)
   ...
   <td><strong>Be careful!</strong></td>
